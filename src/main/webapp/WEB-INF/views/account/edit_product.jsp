    ...
    <div class="row">
        ...
        <div class="span9">
            ...
            <div class="well well-small">
                <div class="row-fluid">
                    <form class="add-product-form" action="${pageContext.request.contextPath}/edit_product" method="post">
                    <div class="span5">
                        <div class="col-md-6">
                    ...
                    <div class="span7">
                            ...
                            <div class="add-product-item product-quantity">
                                ...
                                <input type="number" class="span6" style="width: 55px" name="product_quantity"
                                       min="1" max="999" placeholder="${product.quantity}">
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <label>
                                        <select multiple size="3" id="categorySelect" class="span11" style="width: 200px" name="product_categories"
                                                onchange="myFunction()">
                            ...
                            <div class="add-product-item product-description">
                                ...
                                <div class="tinymce-component">
                                            <textarea id="product_about" name="product_about" required="required"
                                                      data-theme="tinymce" placeholder="${product.description}"></textarea>
                                </div>
                            </div>
