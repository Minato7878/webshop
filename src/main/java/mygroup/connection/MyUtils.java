...
public class MyUtils {
    ...
    public static void storeShoppingCart(HttpSession session, CartDTO cart) {
        session.setAttribute("storedCart", cart);
    }

    public static CartDTO getShoppingCart(HttpSession session) {
        return (CartDTO) session.getAttribute("storedCart");
    }
